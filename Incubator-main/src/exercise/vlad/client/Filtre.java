...
interface Filtre{
    /**
     * @param s : what must be written : a String, an Array of Strings
     * @param g : a graphic variable for making changes regarding the canvas
     * @param width : the width where to write from 
     * @param height : the height where to write from
     */
    ...
    public void setText();                                                
    /**
     * @param s : word received for comparing the filter's condition
     */

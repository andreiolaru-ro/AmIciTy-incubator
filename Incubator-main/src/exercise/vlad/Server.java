...
public class Server
{
	 ...
	 *             : param received
	 * @throws IOException
	 *              : due to the fact that it contains instance of Server
	 */
	...
	/**
	 * @throws IOException
	 *              : because of the work with Server and Client
	 */
	...
	void start() throws IOException
	{
		...
		// initializez variabila PrintWriter out, prin care fac redirectarea
		// catre client
		...
		while (true)
		{
			...
			try
			{
				...
				{
					case 0 :
						out.println(Strings.s1);
						Thread.sleep(4000);
						break;
					case 1 :
						out.println(Strings.s2);
						Thread.sleep(5000);
						break;
					case 2 :
						out.println(Strings.s3);
						Thread.sleep(3000);
						break;
					case 3 :
						out.println(Strings.s4);
						Thread.sleep(6000);
						break;
					case 4 :
						out.println(Strings.s5);
						Thread.sleep(2000);
						break;
					case 5 :
						out.println(Strings.s6);
						Thread.sleep(5000);
						break;
					case 6 :
						out.println(Strings.s7);
						Thread.sleep(3000);
						break;

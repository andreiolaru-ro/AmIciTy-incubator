...
public class ContextCore {
	 ...
	 */
	LinkedBlockingQueue<Notification> notificationQueue;
	...
	/**
	 * @return the notification used to notify an intelligent module that a
	 *         ContextItem is ready to be pulled
	 */

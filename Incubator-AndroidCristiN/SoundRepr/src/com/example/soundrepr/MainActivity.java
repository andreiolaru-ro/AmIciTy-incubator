...
/**
 * @author ''Azgabast''
 * The main activity, where I periodically listen to sounds and represent the highest
 * level heard within the time interval
 */
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		final Runnable r = new Runnable() {
			...
			{	
				...
				for( int i = 0; i < 9; i ++) {
					gvd[i] = new GraphViewData(gvd[i+1].valueX, gvd[i+1].valueY);
				}
